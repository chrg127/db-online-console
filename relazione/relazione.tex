...
\begin{center}
	...
	1  & Login di un utente & 100 al giorno \\ \hline
    2  & Registrare la sottoscrizione di un piano & 20 al mese \\ \hline
    3  & Registrare la cancellazione di un piano & 5 al mese \\ \hline
    4  & Cercare un gioco per titolo/genere/azienda e usando un filtro & 300 al giorno \\ \hline
    5  & Visualizzare i giochi più giocati e quelli più preferiti & 200 al giorno \\ \hline
    6  & Registrare l'acquisto di una copia di un videogioco & 2 al giorno \\ \hline
    7  & Cercare un utente usando un filtro & 100 al giorno \\ \hline
    8  & Visualizzare il numero di ore di gioco giornaliero e totale di un utente & 100 al giorno \\ \hline
    9  & Visualizzare i giochi preferiti di un utente & 100 al giorno \\ \hline
    10 & Aggiungere un gioco tra i preferiti & 10 al giorno \\ \hline
    11 & Registrare la creazione di una sessione di gioco & 10 al giorno \\ \hline
    12 & Visualizzare quante sessioni un utente ha creato o ha partecipato per un videogioco & 100 al giorno \\ \hline
...
\begin{center}
	...
	\rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 5000L, 500.000 al giorno } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	Piano           & E & 1 & S \\ \hline
	\rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 12L + 2S, 320 al mese} \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	\rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 12L + 1S, 70 al mese} \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	\rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 1000L, 300.000 al giorno} \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	Preferenza & R & 50 & L \\ \hline
        \rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 1650L, 330.000 al giorno } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 530L + 1S, 1064 al giorno } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 10.000L, 1.000.000 al giorno } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	Gioca   & R & 300 & L \\ \hline
	Partita & E & 300 & L \\ \hline
    \rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 600L, 60.000 al giorno } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 10L, 1000 al giorno } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 1S, 20 al giorno } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 300L + 8S, 3160 al giorno } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
    ...
    \rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 240L, 24.000 al giorno } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	Acquisto				& R & 5000 		& L \\ \hline
	Piano				& E & 30.000		& L \\ \hline
	Tipologia			& R & 1 			& L \\ \hline
	Tipologia piano		& E & 1 			& L \\ \hline
    \rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 35.005L, 35.005 al mese } \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
In questo caso, l'avere la ridondanza permette di fare metà delle letture.
...
\begin{center}
	...
	Sottoscrittura  & R & 1 & S \\ \hline
	Piano           & E & 1 & S \\ \hline
	\rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 6L + 2S, 200 al mese} \\ \hline
	\end{tabular}
\end{center}
\end{table}
...
\begin{center}
	...
	Sottoscrittura   & R & 3 & L \\ \hline
	Piano Cancellato & E & 1 & S \\ \hline
	\rowcolor{rowc} \multicolumn{4}{|c|}{\textbf{Totale}: 6L + 1S, 40 al mese} \\ \hline
	\end{tabular}
\end{center}
\end{table}
